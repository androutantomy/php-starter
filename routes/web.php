...
use App\Http\Controllers\ProgramPiramidController;
use App\Http\Controllers\ProgramSegitigaController;
...
Route::group(['middleware' => ['web', 'auth', 'verified']], function () {
    ...
    Route::resource('piramida', ProgramPiramidController::class)->only('index');

    Route::resource('segitiga', ProgramSegitigaController::class)->only('index');
});
