            ...
            <ul class="navbar-nav" id="navbar-nav">
                {{-- <li class="nav-item">
                    <a class="nav-link menu-link" href="{{ route('role.index') }}">
                        <i class="ri-drag-move-line"></i> <span data-key="t-landing">Role Management </span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link menu-link" href="{{ route('permission.index') }}">
                        <i class="ri-drag-move-line"></i> <span data-key="t-landing">Permission Management </span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link menu-link" href="{{ route('route.index') }}">
                        <i class="ri-drag-move-line"></i> <span data-key="t-landing">Route Management </span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link menu-link" href="{{ route('user.index') }}">
                        <i class="ri-drag-move-line"></i> <span data-key="t-landing">User Management </span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link menu-link" href="{{ route('menu.index') }}">
                        <i class="ri-drag-move-line"></i> <span data-key="t-landing">Menu Management </span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link menu-link" href="{{ route('setting.index') }}">
                        <i class="ri-drag-move-line"></i> <span data-key="t-landing">Setting </span>
                    </a>
                </li> --}}
