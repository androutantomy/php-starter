        ...
        <div class="modal-content">
            <form action="{{ route('user.store') }}" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="name" class="form-label">Pasword</label>
                        <input type="password" class="form-control" id="password" placeholder="Password" name="password">
                        <x-form.validation.error name="username" />
                    </div>
                    <div class="mb-3">
                        <label for="name" class="form-label">Nomor handphone</label>
                        <input type="text" class="form-control" id="no_hp" placeholder="Nomor handphone" name="no_hp">
                        <x-form.validation.error name="no_hp" />
                    </div>
                    <div class="mb-3">
                        <label for="name" class="form-label">Nomor WA</label>
                        <input type="text" class="form-control" id="wa" placeholder="Nomor WA" name="wa">
                        <x-form.validation.error name="wa" />
                    </div>
                    <div class="mb-3">
                        <label for="name" class="form-label">Pin</label>
                        <input type="text" class="form-control" id="pin" placeholder="Pin" name="pin">
                        <x-form.validation.error name="pin" />
                    </div>
